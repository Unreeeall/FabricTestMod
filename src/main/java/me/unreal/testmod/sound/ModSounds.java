package me.unreal.testmod.sound;
...
public class ModSounds {
    ...
    public static RegistryKey<JukeboxSong> BAR_BRAWL_KEY = RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(TestMod.MOD_ID, "bar_brawl"));
